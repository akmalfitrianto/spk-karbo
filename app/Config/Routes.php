...
$routes->get('alternatif/list', 'Alternatif::list');

$routes->post('alternatif/create', 'Alternatif::create');
$routes->post('alternatif/update', 'Alternatif::update');
$routes->post('alternatif/delete', 'Alternatif::delete');
$routes->post('alternatif/getDataById', 'Alternatif::getDataById');
